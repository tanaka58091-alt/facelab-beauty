  ...
  nasolabialFold: [
    {
      tag: '構造', emoji: '🍑',
      title: 'ほうれい線の正体',
      body: 'ほうれい線は皮膚のシワというより、ほおと口元の境目にできる"段差"として見えます。だからこそ、ほおを引き上げる動きが印象に効いてきます。',
    },
    {
      tag: 'ケア', emoji: '💆',
      title: '保湿だけでは消えない',
  ...
  puffiness: [
    {
      tag: '循環', emoji: '💧',
      title: 'むくみと「めぐり」の関係',
      body: '顔のむくみは、水分や塩分・睡眠・姿勢など複数の要因が重なって起こると言われます。顔や首まわりを動かすこと自体が、めぐりを助けるはたらきをします。',
    },
    {
      tag: '生活', emoji: '🌙',
      title: '寝起きのむくみ対策',
  ...
  longLowerFace: [
    {
      ...
      body: '鼻の下からあご先が長く見えるかどうかは骨格による個人差が大きい部分です。横方向のメリハリを足すと、同じ骨格でも縦長感は和らぎます。',
    },
    {
      tag: '筋肉', emoji: '💪',
  ...
  templeHollow: [
    {
      ...
      body: 'こめかみは、年齢とともに変化が現れやすい部位のひとつと言われます。ここがふっくらすると顔まわりの印象がやわらぎます。側頭部をゆるめるケアがおすすめです。',
    },
    {
      tag: 'ケア', emoji: '🌿',
